...
import resDevelopers from '@site/src/components/Profiles/ResTechLeads';
...
<div className="Lead">
    <ProfilePic 
        githubUrl={leaders[0].githubUrl}
        imgSrc={leaders[0].imgSrc}
        altText={leaders[0].altText}
    />
</div>
...
<div className="Lead">
    <ProfilePic 
        githubUrl={leaders[1].githubUrl}
        imgSrc={leaders[1].imgSrc}
        altText={leaders[1].altText}
    />
</div>
...
<div className="Lead">
    <ProfilePic 
        githubUrl={resDevelopers[0].githubUrl}
        imgSrc={resDevelopers[0].imgSrc}
        altText={resDevelopers[0].altText}
    />
</div>
...
<div className="Lead">
    <ProfilePic 
        githubUrl={resDevelopers[1].githubUrl}
        imgSrc={resDevelopers[1].imgSrc}
        altText={resDevelopers[1].altText}
    />
</div>
